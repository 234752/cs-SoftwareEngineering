...
public class TransportMinigame : MonoBehaviour, IMinigame
{
    ...
    public List<MeanOfTransport> DisplayListOfAvailableTransport()
    {
        ...
        List<MeanOfTransport> availabeMeansOfTransport = new List<MeanOfTransport>();
    ...
    public void StartMinigame()
    {
        ...
        List<MeanOfTransport> displayedAvailableTransport = DisplayListOfAvailableTransport();
